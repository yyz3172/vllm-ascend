...
| 角色 | 启动入口 | Shell 模板（可覆盖） |
|------|----------|------------------------|
| Prefill | `launch_prefill_single_node_4cards.py` | `Qwen3-32B/run_prefill_4cards.sh`（默认） |
| Decode | `launch_decode_single_node_4cards.py` | `Qwen3-32B/run_decode_4cards.sh`（默认） |

...
namespace ops {
class TurboquantPackKvForCacheV2 : public OpDef {
public:
    explicit TurboquantPackKvForCacheV2(const char* name) : OpDef(name)
    {
        this->Input("key")
            .ParamType(REQUIRED)
        ...
        this->Output("packed_v")
            ...
            .Format({ge::FORMAT_ND, ge::FORMAT_ND})
            .UnknownShapeFormat({ge::FORMAT_ND, ge::FORMAT_ND});
        // 0 = MIX KFC batched pack; 1 = AIV-only reference (NO_KFC debug)
...
OP_ADD(TurboquantPackKvForCacheV2);
}  // namespace ops

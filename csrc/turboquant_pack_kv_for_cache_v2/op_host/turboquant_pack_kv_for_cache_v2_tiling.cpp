...
#include "turboquant_pack_kv_for_cache_v2_tiling.h"
...
static ge::graphStatus TurboquantPackKvForCacheV2TilingFunc(gert::TilingContext* context)
{
    ...
    TurboquantPackKvForCacheV2TilingData tilingData {};
...
IMPL_OP_OPTILING(TurboquantPackKvForCacheV2)
    .Tiling(TurboquantPackKvForCacheV2TilingFunc);

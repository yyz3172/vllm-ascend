...
namespace ops {
class TurboquantPackKvForCacheV2ToCache : public OpDef {
public:
    explicit TurboquantPackKvForCacheV2ToCache(const char* name) : OpDef(name)
    {
        this->Input("key")
            .ParamType(REQUIRED)
...
OP_ADD(TurboquantPackKvForCacheV2ToCache);
}  // namespace ops

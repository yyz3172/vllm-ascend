...
if [[ "$SOC_VERSION" =~ ^ascend310 ]]; then
    ...
    CUSTOM_OPS="moe_grouped_matmul;grouped_matmul_swiglu_quant_weight_nz_tensor_list;lightning_indexer_vllm;sparse_flash_attention;matmul_allreduce_add_rmsnorm;moe_init_routing_custom;moe_gating_top_k;add_rms_norm_bias;apply_top_k_top_p_custom;transpose_kv_cache_by_block;copy_and_expand_eagle_inputs;causal_conv1d;lightning_indexer_quant;turboquant_rotate_matmul_probe;turboquant_pack_kv_for_cache_fused;turboquant_pack_kv_for_cache_v2;turboquant_pack_kv_for_cache_v2_to_cache;turboquant_pack_kv_for_cache_v3;turboquant_pack_kv_for_cache_v3_to_cache;turboquant_pack_kv_for_cache_to_cache;turboquant_fused_infer_attention_score8bit;turboquant_decode_paged8bit;turboquant_attention_paged8bit;"
    SOC_ARG="ascend910b"

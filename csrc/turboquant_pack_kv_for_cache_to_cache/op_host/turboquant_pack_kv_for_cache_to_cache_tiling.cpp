...
#include "turboquant_pack_kv_for_cache_to_cache_tiling.h"
...
static ge::graphStatus TurboquantPackKvForCacheToCacheTilingFunc(gert::TilingContext* context)
{
    ...
    TurboquantPackKvForCacheToCacheTilingData tilingData {};
...
IMPL_OP_OPTILING(TurboquantPackKvForCacheToCache)
    .Tiling(TurboquantPackKvForCacheToCacheTilingFunc);

...
namespace ops {
class TurboquantPackKvForCacheToCache : public OpDef {
public:
    explicit TurboquantPackKvForCacheToCache(const char* name) : OpDef(name)
    {
...
OP_ADD(TurboquantPackKvForCacheToCache);
}  // namespace ops

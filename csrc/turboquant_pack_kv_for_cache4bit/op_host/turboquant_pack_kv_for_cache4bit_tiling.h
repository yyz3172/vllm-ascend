...
BEGIN_TILING_DATA_DEF(TurboquantPackKvForCache4bitLargeContigTilingData)
TILING_DATA_FIELD_DEF_STRUCT(TCubeTiling, cubeTiling);
TILING_DATA_FIELD_DEF(uint32_t, nVec);
TILING_DATA_FIELD_DEF(uint32_t, vecPerCore);
TILING_DATA_FIELD_DEF(uint32_t, numHeads);
...
REGISTER_TILING_DATA_CLASS(TurboquantPackKvForCache4bit_1, TurboquantPackKvForCache4bitLargeContigTilingData)

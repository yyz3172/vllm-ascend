...
namespace ops {
class TurboquantFusedInferAttentionScore8bit : public OpDef {
public:
    explicit TurboquantFusedInferAttentionScore8bit(const char* name) : OpDef(name)
    {
        this->Input("query")
            .ParamType(REQUIRED)
...
OP_ADD(TurboquantFusedInferAttentionScore8bit);
}  // namespace ops

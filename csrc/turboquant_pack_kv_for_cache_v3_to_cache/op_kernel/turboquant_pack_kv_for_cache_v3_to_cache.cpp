...
class TurboquantPackKVForCacheV3ToCache {
public:
    __aicore__ inline explicit TurboquantPackKVForCacheV3ToCache(AscendC::TPipe* pipe)
        : pipe_(pipe) {}
...
extern "C" __global__ __aicore__ void turboquant_pack_kv_for_cache_v3_to_cache(
    GM_ADDR key,
    GM_ADDR value,
    GM_ADDR codebook,
    GM_ADDR rotation_t,
    ...
    AscendC::TPipe pipe;
    TurboquantPackKVForCacheV3ToCache op(&pipe);
    op.Init(
        key,
        value,
        codebookPtr,

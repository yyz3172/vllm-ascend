...
namespace ops {
class TurboquantPackKvForCacheV3ToCache : public OpDef {
public:
    explicit TurboquantPackKvForCacheV3ToCache(const char* name) : OpDef(name)
    {
        this->Input("key")
            .ParamType(REQUIRED)
...
OP_ADD(TurboquantPackKvForCacheV3ToCache);
}  // namespace ops

...
#include "turboquant_pack_kv_for_cache_v3_to_cache_tiling.h"
...
static ge::graphStatus TurboquantPackKvForCacheV3ToCacheTilingFunc(gert::TilingContext* context)
{
    ...
    if (*nVecPtr < 1 || *slotWKPtr < 1 || *slotWVPtr < 1 || *vecPerCorePtr < 1 || *numHeadsPtr < 1 ||
        *cacheSlotsPtr < 1) {
    ...
    TurboquantPackKvForCacheV3ToCacheTilingData tilingData {};
...
IMPL_OP_OPTILING(TurboquantPackKvForCacheV3ToCache)
    .Tiling(TurboquantPackKvForCacheV3ToCacheTilingFunc);

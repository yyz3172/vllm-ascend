...
std::tuple<at::Tensor, at::Tensor> turboquant_pack_kv_for_cache_v2_meta(
    const at::Tensor &key,
...
TORCH_LIBRARY_IMPL_EXPAND(CONCAT(_C, _ascend), Meta, ops) {
    ...
    ops.impl("turboquant_pack_kv_for_cache_v2", &vllm_ascend::meta::turboquant_pack_kv_for_cache_v2_meta);

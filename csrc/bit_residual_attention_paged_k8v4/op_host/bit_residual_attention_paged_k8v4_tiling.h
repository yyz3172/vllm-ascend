...
TILING_DATA_FIELD_DEF_ARR(uint32_t, TQ_BR_ATTN_MAX_PARALLEL_CORES, qTileTokenStart);
TILING_DATA_FIELD_DEF_ARR(uint32_t, TQ_BR_ATTN_MAX_PARALLEL_CORES, qTileTokenEnd);

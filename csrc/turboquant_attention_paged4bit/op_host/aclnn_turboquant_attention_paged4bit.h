#ifndef ACLNN_TURBOQUANT_ATTENTION_PAGED4BIT_H_
#define ACLNN_TURBOQUANT_ATTENTION_PAGED4BIT_H_
...
aclnnStatus aclnnTurboquantAttentionPaged4bitGetWorkspaceSize(
...
__attribute__((visibility("default")))
aclnnStatus aclnnTurboquantAttentionPaged4bit(
    void* workspace,
    uint64_t workspaceSize,
    aclOpExecutor* executor,
    aclrtStream stream);

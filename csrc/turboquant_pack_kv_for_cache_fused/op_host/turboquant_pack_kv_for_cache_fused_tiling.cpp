...
#include "turboquant_pack_kv_for_cache_fused_tiling.h"
...
static ge::graphStatus TurboquantPackKvForCacheFusedTilingFunc(gert::TilingContext* context)
{
...
IMPL_OP_OPTILING(TurboquantPackKvForCacheFused)
    .Tiling(TurboquantPackKvForCacheFusedTilingFunc);
